	...
	return (
		<footer className="border-t border-black/5 bg-primary-dark text-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div className="space-y-3">
						<Link href="/" className="flex items-center gap-3">
							<Image src="/logo.png" alt="FarmDirect logo" width={56} height={42} />
							<span className="text-lg font-semibold">FarmDirect</span>
						</Link>
						<p className="text-sm text-emerald-100/80">Fresh produce direct from local farms.</p>
					</div>
					...
					<div className="md:flex md:justify-center">
						<nav aria-label="Footer navigation">
							<ul className="grid grid-cols-2 gap-2 text-sm">
								<li>
									<Link href="/" className="text-emerald-50/90 transition hover:text-white">Home</Link>
								</li>
								<li>
									<Link href="/products" className="text-emerald-50/90 transition hover:text-white">Products</Link>
								</li>
								<li>
									<Link href="/about" className="text-emerald-50/90 transition hover:text-white">About</Link>
								</li>
								<li>
									<Link href="/contact" className="text-emerald-50/90 transition hover:text-white">Contact</Link>
								</li>
							</ul>
						</nav>
					</div>
					...
					<div className="space-y-3">
						...
						<div className="flex space-x-3 mt-2" aria-hidden>
							<a href="#" aria-label="Twitter" className="text-emerald-100/80 transition hover:text-white">
							...
							<a href="#" aria-label="Facebook" className="text-emerald-100/80 transition hover:text-white">
								<svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
							...
							<a href="#" aria-label="Instagram" className="text-emerald-100/80 transition hover:text-white">
				...
				<div className="mt-8 border-t border-white/10 pt-6 text-sm text-emerald-100/70 flex flex-col md:flex-row md:justify-between items-center">
